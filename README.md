...
![](https://github.com/x-ndy/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/x-ndy/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/x-ndy/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/x-ndy/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/x-ndy/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/x-ndy/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |          8m9.862s         |     0m57.95s              | 
| `pg_normalized_batch`  |          2m39.757s        |     0m15.38s              | 
| `pg_denormalized`      |          0m18.340s        |     0m04.21s              | 
